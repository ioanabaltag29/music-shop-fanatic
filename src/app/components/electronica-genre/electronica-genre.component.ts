...
@Component({
  selector: 'app-electronica-genre',
  templateUrl: './electronica-genre.component.html',
  styleUrls: ['./electronica-genre.component.css']
})
export class ElectronicaGenreComponent implements OnInit {
  cds: CD[] = [];
  route: any;
